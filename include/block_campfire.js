    ...
    let state = {
        ...
        update() {
            ...
            if (state.toCook.length > 0) {
                ...
                const totalTime = state.itemsConversion.find(ele => {
                ...
                if (state.counter >= totalTime) {
                    ...
                    const conversion = state.itemsConversion.find(ele => {
                        return ele.name === cooking.name;
                    });
            ...
            if (state.burnTime <= 0 && state.temp < 250 && state.toBurn.length > 0 && state.toCook.length > 0) {
                const getFuel = state.toBurn.shift(); // Pull out the next fuel we will burn in this fire
            ...
            if (state.toBurn.length < 15) {
                ...
                if (burnables[0] !== "Small Firewood") {
                    console.log(burnables);
                    console.log(state.fuelTypes);
                }
                if (
        ...
        drawpanel() {
            ...
            $("#sidepanel").html(
                "<b>Fire Pit</b><br />" +
                    ...
                    state.toCook.length +
                    "</span><br />" +
                    '<a href="#" onclick="blockselect.deleteblock()">Delete Block</a><br />' +
